...
public class Form1 extends JFrame {
	...
	private void InitializeComponents() {
		...
		this.setTitle("Validate 5010 837 Professional");
		this.setLayout(null);
		...
		JLabel lblTitle = new JLabel("   Validate 5010 837 Professional");
    ...
    {
        try {
			txtFile.setText(ReadTextFile("EDIFiles\\sample837P.txt"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
