...
public class Form1 extends JFrame {
	...
	private void InitializeComponents() {
		...
		this.setTitle("Validate HIPAA 4010 835 EDI File");
		this.setLayout(null);
		...
		JLabel lblTitle = new JLabel("   Validate HIPAA 4010 835 EDI File");
    ...
    {
        try {
			txtFile.setText(ReadTextFile("EDIFiles\\SampleEDIFile.txt"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} 
