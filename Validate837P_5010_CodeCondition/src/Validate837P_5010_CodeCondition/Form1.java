package Validate837P_5010_CodeCondition;
...
public class Form1 extends JFrame {
	...
	private void InitializeComponents() {
		...
		this.setTitle("Validate 5010 837 Professional - Code Conditions");
		this.setLayout(null);
		...
		JLabel lblTitle = new JLabel("   Validate 5010 837 Professional - Code Conditions");
    ...
    {
        try {
			txtFile.setText(ReadTextFile("EDIFiles\\X223-837-institutional-claim.edi"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
        ...
        ediValidator.setEDIRulesFile("EDIFiles\\Rules_5010_837I_005010X223A2.Rules");
    }
    ...
    private void ediValidator_CustomCondition(Object sender, RDPCrystalEDILibrary.Rules.CodeConditionEventArgs e)
    {
        //In our rules file we have a rule like the following
        //SegPos[277:2]=if ( CodeCondition["test"] ) then Error[ElementHasWrongValue,"Code Condition Works"] end
        //When our validator see this rule with it's CodeCondition this event gets called.
        //It is now up to us to check is the condition is valid

        if (e.getCodeCondition().getId() == "test")
        {
            if (e.getCurrentSegment().getElements().get_Item(0, LightWeightElement.class).getDataValue() == "1")
            {
                e.setConditionValid(true);
            }
        }
    }
    ...
    {
    	ediValidator.addOnCodeCondition(new CodeConditionEvent() {

			@Override
			public void Invoke(Object arg0, CodeConditionEventArgs arg1) {
				// TODO Auto-generated method stub
				ediValidator_CustomCondition(arg0,arg1);
			}
