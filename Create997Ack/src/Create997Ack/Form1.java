...
//please go to javonet to register for a free trial and get your javonet serial number at : my.javonet.com/signin?type=free 
	...
	private void InitializeComponents() {
		...
		this.setTitle("4010 997 File Generation");
		this.setLayout(null);
		...
		JLabel lblTitle = new JLabel("   4010 997 File Generation");
		...
		JLabel lblGeneratedData = new JLabel("Generate 997 Data");
		...
		txt997 = new JTextArea(20,0);
		Border border2 = BorderFactory.createLineBorder(Color.BLACK);
		txt997.setBorder(BorderFactory.createCompoundBorder(border2,
	            BorderFactory.createEmptyBorder(10, 10, 10, 10)));
		txt997.setBorder(border2);
		txt997.setFont(new Font("Microsoft Sans Serif",0,16));
		txt997.setEditable(true);
		txt997.setBounds(10+425,35+176+10+25,393,176);
		content.add(txt997);
    ...
    private void Form1_Load()
    {
        ...
        try {
        	String t=ReadTextFile("EDIFiles\\SampleEDIFileFAIL1.txt");
			txtFile.setText( t );
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
    ...
    private void ValidateEDI()
    {
        try
        {
            ...
            RDPCrystalEDILibrary.Ack997Generator ack = new RDPCrystalEDILibrary.Ack997Generator();
            ack.setPaddingChar('0'); //This char will be used to pad data to meet minimum length.  For example group control numbers
            EDIDocument doc997 = ack.Generate997Acknowledgement(ediValidator);
            SetText(txt997, doc997.GenerateEDIData());
