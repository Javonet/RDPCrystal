...
public class Form1 extends JFrame {
	...
	private void InitializeComponents() {
		...
		this.setTitle("5010 999 File Generation");
		this.setLayout(null);
		...
		JLabel lblTitle = new JLabel("   5010 999 File Generation");
        ...
        this.ediRuleReader.addProgressChanged(new EDIRulesReader.GeneralEvent() {
			...
			@Override
			public void Invoke(Integer progress) {
    ...
    private void Form1_Load()
    {
        ...
        try {
        	String t=ReadTextFile("EDIFiles\\Sample837PFAIL1.txt");
			txtFile.setText( t );
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
