...
public class Form1 extends JFrame {
	...
	private void InitializeComponents() {
		...
		this.setTitle("Validate 5010 834 - Benefit Enrollment");
		this.setLayout(null);
		...
		JLabel lblTitle = new JLabel("   Validate 5010 834 - Benefit Enrollment");
    ...
    {
        try {
			txtFile.setText(ReadTextFile("EDIFiles\\sample834.txt"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
